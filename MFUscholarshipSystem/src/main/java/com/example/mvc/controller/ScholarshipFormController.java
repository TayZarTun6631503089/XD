...
public class ScholarshipFormController {
	...
	public String submitScholarshipForm(Model model) {
		model.addAttribute("scholarshipFormDto",new ScholarshipFormDto());
		return "scholarshipFullForm";
	}

	@PostMapping("/submitForm-view")
	public String getPdfScholarshipForm(@ModelAttribute ScholarshipFormDto scholarshipFormDto,Model model) {
